 ...
 * @deprecated
 */
export declare type AnyRouter<TContext extends Record<string, any> = any> = Router<any, TContext, any, any, any, any, any>;
/**
 * @internal
 * @deprecated
 */
...
export declare class Router<TInputContext extends Record<string, any>, TContext extends Record<string, any>, TMeta extends Record<string, any>, TQueries extends ProcedureRecord<TInputContext, TContext, any, any, any, any, any>, TMutations extends ProcedureRecord<TInputContext, TContext, any, any, any, any, any>, TSubscriptions extends ProcedureRecord<TInputContext, TContext, unknown, unknown, Observable<unknown, unknown>, unknown, unknown>, TErrorShape extends TRPCErrorShape<number>> {
     ...
     */
    middleware<TNewContext extends Record<string, any>>(middleware: MiddlewareFunction<TContext, TNewContext, TMeta>): Router<TInputContext, TNewContext, TMeta, SwapContext<TQueries, TNewContext>, SwapContext<TMutations, TNewContext>, SwapContext<TSubscriptions, TNewContext>, TErrorShape>;
    /**
     * Format errors
     ...
     * @alpha
     */
    flat(): Router<TInputContext, TContext, TMeta, FlatOverwrite<{}, TQueries>, FlatOverwrite<{}, TMutations>, FlatOverwrite<{}, TSubscriptions>, TErrorShape>;
    /**
     * Interop mode for v9.x -> v10.x
     */
    interop(): MigrateRouter<TInputContext, TContext, TMeta, TQueries, TMutations, TSubscriptions, TErrorShape>;
}
/**
 * @deprecated
 */
export declare function router<TContext extends Record<string, any> = {}, TMeta extends Record<string, any> = {}>(): Router<TContext, TContext, TMeta, {}, {}, {}, DefaultErrorShape>;
