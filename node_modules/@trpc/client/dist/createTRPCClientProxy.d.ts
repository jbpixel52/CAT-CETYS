...
export declare type CreateTRPCProxyClient<TRouter extends AnyRouter> = inferRouterProxyClient<TRouter>;
/**
 * @deprecated use `createTRPCProxyClient` instead
 * @internal
 */
export declare function createTRPCClientProxy<TRouter extends AnyRouter>(client: TRPCClient<TRouter>): DecoratedProcedureRecord<TRouter["_def"]["record"], TRouter>;
